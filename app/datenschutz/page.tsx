    ...
    <main className="legal-page">
      <div className="legal-container">
        ...
        <section>
          ...
          <p>Für die Anmeldung im Kundenkonto setzen wir das technisch notwendige Cookie <code>customer_session</code> mit einer Laufzeit von höchstens 30 Tagen. Im nicht öffentlichen Administrationsbereich wird ein Sitzungscookie für höchstens 12 Stunden verwendet. Zur Speicherung Ihrer Entscheidung über den Cookie-Hinweis nutzen wir den lokalen Browserspeicher für höchstens 180 Tage. Diese Speicherungen sind für die jeweiligen Funktionen erforderlich (§ 25 Abs. 2 TDDDG); die Verarbeitung personenbezogener Daten beruht je nach Funktion auf Art. 6 Abs. 1 lit. b oder lit. f DSGVO.</p>
        ...
        <section>
          ...
          <p>Google Tag Manager, Google Analytics, Meta/Facebook Pixel und Microsoft Clarity sind auf dieser Website derzeit technisch nicht aktiviert. Es werden über diese Dienste momentan keine Analyse- oder Marketing-Skripte geladen. Eine spätere Aktivierung erfolgt nur nach einer gesonderten Einwilligung; vor der Aktivierung werden dieser Hinweis und die Einwilligungsauswahl an die tatsächlich eingesetzten Dienste angepasst (Art. 6 Abs. 1 lit. a DSGVO und § 25 Abs. 1 TDDDG).</p>
